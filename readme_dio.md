...
4. edit default.config ,or ref default.config_diotemp.Detail setting can find in [original Poloniexlendingbot configruation](https://poloniexlendingbot.readthedocs.io/en/latest/configuration.html#)
