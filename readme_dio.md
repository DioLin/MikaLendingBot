...
4. edit default.config ,or ref default.config_diotemp.Detail setting can be found in [original Poloniexlendingbot configruation](https://poloniexlendingbot.readthedocs.io/en/latest/configuration.html#)
